...
import { actionsColumn, firstOfColumn, formatColumn, quantityColumn, stockAlertColumn, textColumn, typeColumn } from './columns'
...
export type ProductTableMeta = {
  ...
  isReadOnly: boolean
  /**
   * Products whose stock target has less stock than the job requires, keyed by
   * product id. Non-empty → the table appends an alert column and tints the
   * affected rows red.
   */
  stockShortages?: Map<string, { required: number; available: number }>
}
